...
$stmt = $connection->prepare('SELECT category.categoryname AS categoryname, 
    ...
    SUM(inventory.InventoryValue) AS InventoryValue, 
    SUM(inventory.InventoryCost) AS TotalInventoryCost, 
...
while ($row = $resultCategories->fetch_assoc()) {
    ...
    $data['TotalInventoryCost'][] = $row['TotalInventoryCost'];
}
  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white" href="http://localhost/WEB/inventory-analytics.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
          ...
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
                ...
                <h4 class="mb-0">$<?php echo number_format($totalData['InventoryValue']); ?></h4>
              </div>
            </div>
          ...
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
                ...
                <h4 class="mb-0">$<?php echo number_format($totalData['TotalInventoryCost']); ?></h4>
              </div>
            </div>
            <hr class="dark horizontal my-0">
            <div class="card-footer p-3">
      ...
      <table class="table">
        ...
        <tbody>
           <?php
                    ...
                    $categoryRevenue = array_combine($data['categoryname'], $data['TotalInventoryCost']);
                    ...
                    foreach ($categoryRevenue as $categoryname => $totalInventoryCost) {
                        echo '<tr>';
                        echo '<td>' . fetchCategoryName($connection, $categoryname) . '</td>';
                        echo '<td class="text-center">$' . number_format($totalInventoryCost) . '</td>';
                        echo '</tr>';
                    }
            ?>
        </tbody>
